...
import com.doctrine7.service.kafka.KafkaProducerShedule;
...
public class SheduleService {
    ...
    private final KafkaProducerShedule kafkaProducerShedule;
    ...
    public void writeProcedureChange(SheduleChangeDto sheduleChangeDto) {
        ...
        kafkaProducerShedule.sendMessage(topicSheduleChange, key, sheduleChangeDto);
    }

    public void writeProcedureDelete(SheduleChangeDto sheduleChangeDto) {
        logger.info("write schedule deleting to Kafka.\n{}", sheduleChangeDto);
        kafkaProducerShedule.sendMessage(topicSheduleDelete, key, sheduleChangeDto);
    }
}
